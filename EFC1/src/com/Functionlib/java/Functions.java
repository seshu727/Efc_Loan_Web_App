...
import com.Utilities.java.Excel;
		...
		StringSelection s = new StringSelection("C:\\Users\\PC\\Pictures\\Screenshots\\Screenshot (1).png");
		 ...
		 if(driver.findElement(By.xpath("//zc-wrapper-validation-messages[1]/zc-file[1]/div[2]/ul[1]/li[1]/span[1]")).isDisplayed()) {
			 ...
			 System.out.println("File upload failed");
		             ...
		             Thread.sleep(8000);
					 driver.findElement(By.xpath("//input[@type='text'][@id='name']")).sendKeys("Ritheesh");
					 Thread.sleep(1000);
			 ...
			 public static void homeLoan() throws Throwable {
				...
				Thread.sleep(4000);
				driver.findElement(By.xpath("//button[contains(text(), 'New Appraisal')]")).click();
				Thread.sleep(4000);
		       // driver.findElement(By.xpath("/html/body/app-root/app-page-layout/div[2]/div[3]/div/app-page/div/zc-page-render/zc-block-tree-node/zc-block-tree-node/app-com-render/div/zc-widget-data-list/div/p-table/div/div[2]/table/tbody/tr[1]/td[1]")).click();
			    ...
			    @SuppressWarnings("static-access")
		     	public static void navigatesTonewAppraisalawithexistingclient() throws Throwable {
				Thread.sleep(4000);
				driver.findElement(By.xpath("//app-page-layout[1]/div[2]/div[1]/a[1]")).click();
				Thread.sleep(4000);
				driver.findElement(By.xpath("//span[@class='nav-link-text'][contains(text(),'Appraisals')]")).click();
			  ...
			  public static void navigatesToclientcreation() throws Throwable {
					...
					Thread.sleep(4000);
					driver.findElement(By.xpath("//div[@class='zc-form-add-btn ng-star-inserted']//button[@class='btn btn-primary ng-star-inserted']")).click();
					Thread.sleep(4000);
			}
			 ...
			 public static void loanApp() throws Throwable {
				 ...
				 Thread.sleep(4000);
				 driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/app-page-layout[1]/div[2]/div[3]/div[1]/app-page[1]/div[1]/zc-page-render[1]/zc-block-tree-node[1]/zc-block-tree-node[1]/app-com-render[1]/div[1]/zc-widget-stage-form[1]/zc-stage-form[1]/div[2]/div[3]/div[1]/div[2]/zc-widget-form[1]/div[1]/div[1]/div[1]/form[1]/formly-form[1]/formly-field[1]/zc-wrapper-label[1]/zc-wrapper-fieldset[1]/div[1]/zc-wrapper-validation-messages[1]/zc-currency-field[1]/div[1]/div[2]/div[1]/input[1]")).sendKeys("120000000");
				 Thread.sleep(2000);
		  ...
		  System.out.println("Test Failed");
			 ...
			 public static void Security() throws Throwable {
				...
				// driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/app-page-layout[1]/div[2]/div[3]/div[1]/app-page[1]/div[1]/zc-page-render[1]/zc-block-tree-node[1]/zc-block-tree-node[1]/app-com-render[1]/div[1]/zc-widget-stage-form[1]/zc-stage-form[1]/zc-stage-view[1]/div[1]/div[1]/div[1]/div[1]/div[3]/ul[1]/li[3]/a[1]")).click();
                 driver.findElement(By.xpath("/html/body/app-root/app-page-layout/div[2]/div[3]/div/app-page/div/zc-page-render/zc-block-tree-node/zc-block-tree-node/app-com-render/div/zc-widget-stage-form/zc-stage-form/div[2]/div[3]/div/div[1]/div[2]/div/div/button[2]")).click();
                 System.out.println("After clicking review button");
            	 Thread.sleep(2000);
            	 //clicking forword btn
                 driver.findElement(By.xpath("/html/body/app-root/app-page-layout/div[2]/div[3]/div/app-page/div/zc-page-render/zc-block-tree-node/zc-block-tree-node/app-com-render/div/zc-widget-stage-form/zc-stage-form/zc-stage-view/div/div[2]/div[1]/button")).click();
           	     ...
           	     Thread.sleep(2000);
                 driver.findElement(By.id("approvalActionComment")).sendKeys("ok");
	 ...
	 */
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/app-page-layout[1]/div[2]/div[3]/div[1]/app-page[1]/div[1]/zc-page-render[1]/zc-block-tree-node[1]/zc-block-tree-node[1]/app-com-render[1]/div[1]/zc-widget-stage-form[1]/zc-stage-form[1]/div[2]/div[3]/div[1]/div[2]/zc-widget-form[1]/div[1]/div[1]/div[1]/form[1]/formly-form[1]/formly-field[7]/zc-wrapper-label[1]/zc-wrapper-fieldset[1]/div[1]/zc-wrapper-validation-messages[1]/zc-table-field[1]/div[1]/div[1]/p-table[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[3]/a[1]")).click();
		salesmonthlycode();
		driver.findElement(By.xpath(
		...
		driver.findElement(By.id("product_sold")).sendKeys("100");
		driver.findElement(By.id("sales_quantity")).sendKeys("10");
		driver.findElement(By.id("sales_unit_price")).sendKeys("10000000");
		driver.findElement(By.id("purchase_unit_price")).sendKeys("1000");
		Thread.sleep(2000);
		driver.findElement(By.xpath("//form[1]/formly-form[1]/div[1]/button[2]")).click();
		
		driver.findElement(By.id("other_total_margin_sales")).sendKeys("100000000");
		
		
		driver.findElement(By.id("other_total_margin_purchases")).sendKeys("1000000000");
	
		
		driver.findElement(By.id("other_total_profit_margin")).sendKeys("100000000");
		
		driver.findElement(By.id("other_total_margin")).sendKeys("15");
		Thread.sleep(1000);
		driver.findElement(By.xpath("//div[1]/div[1]/div[2]/div[1]/div[1]/button[1]")).click();
			...
			public static void Purchases() throws Throwable {
				Thread.sleep(3000);
				driver.findElement(By.xpath("//zc-widget-stage-form[1]/zc-stage-form[1]/div[2]/div[1]/i[1]")).click();
				Thread.sleep(3000);
				//commonFields();
